...
describe "Authentication" do
  ...
  describe "signin" do
    ...
    describe "for non-signed-in users" do
      ...
      before { sign_in user, no_capybara: true }		# we are going to be using direct http calls
      ...
      before { sign_in non_admin, no_capybara: true }	# we are going to be using direct http calls
